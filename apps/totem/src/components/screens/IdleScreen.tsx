...
// ---------------------------------------------------------------------------
// Salon showcase photos (Unsplash — beauty/salon themed)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Static displacement map SVG filter (no feTurbulence = no trembling)
// Uses a pre-baked WebP displacement texture for subtle glass refraction
// ---------------------------------------------------------------------------
...
function BackgroundSlideshow() {
  ...
  useEffect(() => {
    const id = setInterval(advance, SLIDE_INTERVAL_MS);
  ...
  return (
    <div aria-hidden="true" className="absolute inset-0 z-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: [
            "linear-gradient(to bottom, rgba(74,13,46,0.75) 0%, rgba(74,13,46,0.55) 40%, rgba(74,13,46,0.65) 70%, rgba(74,13,46,0.85) 100%)",
          ].join(", "),
        }}
      />
      ...
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 70% 60% at 50% 50%, transparent 0%, rgba(74,13,46,0.40) 100%)",
        }}
      />
    </div>
  );
...
export default function IdleScreen() {
  const goToIdentify = useKioskStore((s) => s.goToIdentify);
  ...
  return (
    <div
      className="relative flex flex-col items-center justify-center w-full h-screen overflow-hidden bg-brand-text"
      onPointerDown={(e) => { e.preventDefault(); goToIdentify(); }}
    >

      {/* ------------------------------------------------------------------ */}
      {/* Fullscreen photo slideshow behind everything                        */}
      {/* ------------------------------------------------------------------ */}
      <BackgroundSlideshow />
      ...
      {/* ------------------------------------------------------------------ */}
      {/* Main content — liquid glass panel (single element approach)        */}
      {/* ------------------------------------------------------------------ */}
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 w-full px-8">
        <motion.div
          ...
          className="relative w-full max-w-[920px] flex flex-col items-center gap-12"
        >
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: "radial-gradient(circle, rgba(255,182,217,0.7) 0%, rgba(255,182,217,0) 70%)",
                  filter: "blur(30px)",
                }}
              />
              <Image
            ...
            <h1
              className="font-display text-[68px] text-white text-center leading-[1.1] font-bold drop-shadow-lg"
              style={{ letterSpacing: "-0.02em" }}
            >
              Cheia de Charme
            </h1>
            <p
              className="font-body text-[26px] font-medium tracking-[0.15em] uppercase text-center"
          ...
          >
            ...
            {/* Button wrapper — subtle breath scale */}
            <motion.div
            ...
            >
              <button
                ...
                style={{
                  background: "linear-gradient(to right, #C2185B, #D94B8C)",
                  boxShadow: "0 0 30px rgba(194,24,91,0.45), 0 8px 32px rgba(194,24,91,0.30)",
                }}
                aria-label="Toque para começar o atendimento"
              >
                Toque para começar
              </button>
            </motion.div>
