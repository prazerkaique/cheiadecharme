...
function CountdownCircle({ secondsRemaining }: { secondsRemaining: number }) {
  const clamped = Math.max(0, Math.min(secondsRemaining, TOTAL_SECONDS));
        ...
        >
          ...
          <div className="w-full flex flex-col" style={{ gap: "32px" }}>
            ...
            <button
              ...
              style={{ minHeight: "90px", borderRadius: "22px", fontSize: "26px" }}
            >
              Encerrar
            </button>
          </div>
